...
- [ ] 1.1 Confirm and finalize absolute import strategy without TypeScript path aliases for enforced source scope
...
- [ ] 2.1 Refactor internal imports in source-sync modules to absolute imports (non-alias strategy)
- [ ] 2.2 Refactor internal imports in source-preview modules to absolute imports (non-alias strategy)
- [ ] 2.3 Refactor internal imports in source-apply modules to absolute imports (non-alias strategy)
