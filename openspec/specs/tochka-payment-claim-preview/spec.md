# tochka-payment-claim-preview

## Purpose
Support for Tochka PaymentClaim records in preview normalization, including type recognition, field mapping, classification rules, and test coverage.
