...
- Always keep in sync structurally these three pieces: `config/sources.json`, `config/sources.json.example` and tests that mock this configuration. Code examples should use dummy data to not expose sensitive information.
